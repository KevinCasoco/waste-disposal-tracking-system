<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        @if (Auth::user()->role == 'collector')
            <div>
                ...
                <x-text-input id="plate_no" name="plate_no" type="text" class="mt-1 block w-full" :value="old('plate_no', $user->plate_no)"
                    required autofocus autocomplete="plate_no" />
                <x-input-error class="mt-2" :messages="$errors->get('plate_no')" />
            </div>
            <div>
                <x-input-label for="first_name" :value="__('Driver\'s First Name')" />
            ...
            <div>
                <x-input-label for="last_name" :value="__('Driver\'s Last Name')" />
        ...
        @if (Auth::user()->role == 'admin' || Auth::user()->role == 'residents')
            <div>
        ...
        @if (Auth::user()->role == 'residents')
            <div>
                <div class="hidden md:block">
                    ...
                    <x-text-input id="number" name="number" type="tel"
                        class="phone-input mt-1 block-100 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        :value="old('number', $user->number)" style="width: 435px;" required autofocus autocomplete="number" />
                ...
                <div class="md:hidden">
                    ...
                    <x-text-input id="number" name="number" type="tel"
                        class="phone-input mt-1 block-100 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                        :value="old('number', $user->number)" style="width: 326px;" required autofocus autocomplete="number" />
                    <x-input-error class="mt-2" :messages="$errors->get('number')" />
                </div>
            </div>
            ...
            <div class="mt-1">
                ...
                <x-textarea-input id="locationTextarea" rows="4" cols="50" class="block mt-1 w-[100%]"
        ...
        <div class="flex justify-end items-center gap-4">
            <x-primary-button
                class="w-24 justify-center bg-green-500 hover:bg-green-700">{{ __('Save') }}</x-primary-button>
    ...
    <div id="locationModal"
        ...
        <div class="bg-white p-6 rounded-lg shadow-xl w-[280px]">
            <p class="mb-4">You have denied access to your location. Please enable location access in your
                browser settings to use this feature.</p>
