<x-app-layout>
    ...
    <div class="bg-slate-200 flex justify-center items-center py-12">
        {{-- <div class="grid grid-cols-1 md:cols-2 lg:grid-cols-2 gap-4 lg:gap-8 max-w-7xl mx-auto sm:px-6 lg:px-8 md:grid-cols-1 xl:grid-cols-4 xl:grid-rows-3 xl:grid-flow-col flex-grow-0">

            <div class=" flex flex-col justify-start p-4 sm:p-8 sm:grid-cols-1 bg-white dark:bg-gray-800 shadow sm:rounded-lg  md:col-span-2 md:row-span-2">
                <div class="max-w-xl">
