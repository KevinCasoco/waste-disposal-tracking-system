        ...
        <div class="relative min-h-screen md:flex">
            ...
            <div class="flex-grow text-gray-800">
                    ...
                    <div id='recipients' class="p-4 m-1 lg:mt-0 rounded shadow-lg bg-white overflow-x-auto">
                        ...
                        <div x-data="{ scheduleCollectorDelete: false, scheduleCollectorEdit: false, newCollectorSchedules: false, collectorScheduleToDelete: null, collectorScheduleToEdit: null }">
                            ...
                            <div class="md:hidden flex justify-end">
                                <button @click="newCollectorSchedules = true" class=" text-white text-center w-8 h-8"
                ...
                {{ $data->links() }} --}}
                            ...
                            <!-- Add New Users Modal -->
                            <div x-show="newCollectorSchedules"
                                ...
                                <div x-show="newCollectorSchedules" @click.away="newCollectorSchedules = false"
                                    ...
                                    <div class="bg-white py-3 w-full sm:w-[340px] h-full sm:h-[430px]">
                                        ...
                                        <form action="{{ route('collector-schedule.create_collector') }}"
                                            method="post" class="pl-5 pr-5 pt-3 pb-3">
                                            @csrf
                        ...
                        <!-- Delete Modal -->
                        <div x-show="scheduleCollectorDelete"
                            class="fixed inset-0 overflow-y-auto flex items-center justify-center z-30" x-cloak>
                            <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                                <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
                            </div>
                            ...
                            <div x-show="scheduleCollectorDelete" @click.away="scheduleCollectorDelete = false"
                                ...
                                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-col">
                                    ...
                                    <div class="flex justify-end items-end pb-2">
                                        <form method="post"
                                            :action="`{{ route('collector-schedule-list.collector_schedule_destroy', '') }}/${collectorScheduleToDelete}`">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit"
                        ...
                        <!-- Edit Modal -->
                        <div x-show="scheduleCollectorEdit"
                            class="fixed inset-0 overflow-y-auto flex items-center justify-center z-30" x-cloak>
                            <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                                <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
                            </div>
                            ...
                            <div x-show="scheduleCollectorEdit" @click.away="scheduleCollectorEdit = false"
                                ...
                                <div class="bg-white py-3 w-full sm:w-[345px] h-full sm:h-[430px]">
                                    <div class="flex items-center justify-between">
                                        ...
                                        <button @click="scheduleCollectorEdit = false" aria-label="Close"
                                    ...
                                    @foreach ($data as $item)
                                        <div x-show="collectorScheduleToEdit.toString() === '{{ $item->id }}'">
                                            <form method="post"
                                                :action="`{{ route('collector-schedule-list.collector_update_schedule', '') }}/${collectorScheduleToEdit}`"
                                                ...
                                                <div class="flex justify-end items-end pt-1">
                                                    ...
                                                    <div class="md:hidden absolute mr-[93px]">
                                                        <button @click.prevent="scheduleCollectorEdit = false"
                                                            class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600">
                                                            Cancel
                                                        </button>
                                                    </div>
