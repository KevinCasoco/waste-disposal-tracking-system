        ...
        <script>
            ...
            function app() {
                return {
                    ...
                    events: [], // Empty initially, events will be fetched from the server
                    ...
                    addEvent() {
                        ...
                        // Send an AJAX request to the Laravel backend to add the event
                        fetch('/add-event', {
                            method: 'POST',
                            headers: {
                        ...
                        .then(data => {
                            ...
                            // Assuming you have a function to update the calendar on the frontend
                            // updateCalendar(data.event);

                            // Fetch events again to update the events array
                            this.fetchEvents();
                    ...
                    fetchEvents() {
                        ...
                        .then(response => response.json())
                        .then(data => {
                            this.events = data.events; // Update the events array
                        })
                        .catch(error => {
                            console.error('Error:', error);
                        });
