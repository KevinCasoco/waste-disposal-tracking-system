                ...
                <main class="p-3 sm:p-4 space-y-5">
                    ...
                    <div id='recipients' class="p-4 m-1 lg:mt-0 rounded shadow-lg bg-white overflow-x-auto">
                        ...
                        <div x-data="{ collectorResidentsDelete: false, collectorEdit: false, collectorNewCollector: false, itemToDelete: null, itemToEdit: null }">
                            ...
                            <!-- Delete Modal -->
                            <div x-show="collectorResidentsDelete"
                                ...
                                <div x-show="collectorResidentsDelete" @click.away="collectorResidentsDelete = false"
                                    ...
                                    <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-col">
                                        ...
                                        <div class="flex justify-end items-end pb-2">
                                            <form method="post"
                                                :action="`{{ route('collector-residents.destroy_collector_residents', '') }}/${itemToDelete}`">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit"
                                        ...
                                        <div class="bg-white py-3 w-full sm:w-[345px] h-full sm:h-[495px]">
                                            ...
                                            @foreach ($data as $item)
                                                <div x-show="itemToEdit.toString() === '{{ $item->id }}'">
                                                    <form method="post"
                                                        :action="`{{ route('collector-residents.update_collector', '') }}/${itemToEdit}`"
                                                        ...
                                                        <input type="text" name="first_name"
                                                            ...
                                                            oninput="this.value = this.value.replace(/[^a-zA-Z\s]/g, '')"class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block mb-2 p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white w-full sm:w-[300px]"
                                                            required>
                            ...
                            <!-- Add New Users Modal -->
                            <div class="hidden md:block">
                                <div x-show="collectorNewCollector"
                                    class="fixed inset-0 overflow-y-auto flex items-center justify-center z-30"
                                    x-cloak>
                                    <div class="fixed inset-0 transition-opacity" aria-hidden="true">
                                        <div class="absolute inset-0 bg-gray-500 opacity-75"></div>
                                    ...
                                    <div x-show="collectorNewCollector" @click.away="collectorNewCollector = false"
                                        ...
                                        <div class="bg-white py-3 w-full sm:w-[655px] h-full sm:h-[355px]">
                                            ...
                                            <hr class="bg-black border-gray-300 w-full">
                                            <form
                                                action="{{ route('collector-residents.create_collector_residents') }}"
                                                method="post"
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        class="flex flex-col sm:flex-row items-end sm:items-center justify-end sm:mt-4 md:mt-6 mt-6 ">
                                                        <button type="submit"
