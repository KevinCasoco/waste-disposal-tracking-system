...
<div x-data="{show : true}" x-show="show" x-init="setTimeout(()=> show = false, 5000)" class="bg-blue-200 fixed m-10 bottom-0 right-0 z-20 border-t-4 border-black rounded-b text-blue-900 px-4 py-3 shadow-md" role="alert">
    <div class="flex">
      ...
      <div>
        <p class="mt-1.5 text-sm text-black">{{session('message')}}</p>
      </div>
    </div>
  </div>
