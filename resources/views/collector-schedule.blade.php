                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="btn-group mb-2 ml-1" role="group" aria-label="Calendar Actions">
                            <a href="{{ asset('add-collector')}}" class="btn btn-success px-3">Add</a>
                        </div>
                    ...
                    <form action="{{ route('collector-schedule.sms_controller') }}" method="POST" class="ml-3">
                        @csrf
                        <button class="py-2 px-2 mb-3 rounded bg-red-500 hover:bg-green-700 text-white" type="submit" type="submit"><i class="ri-mail-send-line mr-1"></i>Notify Users(sms)</button>
                    </form>
